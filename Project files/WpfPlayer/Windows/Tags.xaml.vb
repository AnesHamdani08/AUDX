...
Public Class Tags
    ...
    Public Sub New(_Path As String, _Player As Player)
        ' This call is required by the designer.
        InitializeComponent()
        ' Add any initialization after the InitializeComponent() call.
        Path = _Path
        Player = _Player
        AddHandler Player.MediaLoaded, AddressOf Player_MediaLoaded
    End Sub
    Private Sub Overlay(IsVisible As Boolean)
        If IsVisible Then
            showoverlay.IsChecked = True
        Else
    ...
    Private Sub Exitbtn_Click(sender As Object, e As RoutedEventArgs) Handles Exitbtn.Click
        RemoveHandler Player.MediaLoaded, AddressOf Player_MediaLoaded
        Me.Close()
    End Sub
    Private Sub Prepare()
        ...
        Else
            ...
            TopImage.Source = New BitmapImage(New Uri("pack://application:,,,/WpfPlayer;component/Res/song.png"))
        End If
        Cover = Nothing
        ...
        Catch ex As Exception
            MessageBox.Show(Me, "This file type is unsupported or the file has been externally modified.")
    ...
    Private Sub fingerprintingbtn_Click(sender As Object, e As RoutedEventArgs) Handles fingerprintingbtn.Click
        ...
        If TitleNArtist.ShowDialog Then
            Dim Result = Global.MusicBrainz.Search.Recording(TitleNArtist.Input.Split(";")(0), artist:=TitleNArtist.Input.Split(";")(1))
