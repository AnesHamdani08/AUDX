    ...
    Namespace ContentDirectory_v1
        Public Class Resource
            ...
            Public Sub New(ByVal xmlNode As XmlNode)
                ...
                For Each tmpAttr As XmlAttribute In xmlNode.Attributes
                    Debug.WriteLine("Resource attribute: " & tmpAttr.Name & " value: " & tmpAttr.Value)
                    Select Case tmpAttr.Name.ToLower
                        Case "duration"
                ...
                Me.URI = New Uri(xmlNode.InnerText) 'the url which we wil send to the media renderer to play it
                Debug.WriteLine("Resource url: " & Me.URI.ToString)
            End Sub
        ...
        Public Class CD_Object
            ...
            Public Sub New(ByVal xmlNode As XmlNode)
                Me._XMLDump = xmlNode.OuterXml
                'Read the 'DIDL-Lite' attributes of the Object
                For Each tmpAttr As XmlAttribute In xmlNode.Attributes
                    Debug.WriteLine("attribute: " & tmpAttr.Name & " value: " & tmpAttr.Value)
                    Select Case tmpAttr.Name.ToLower
                        Case "id"
                ...
                For Each childNode As XmlNode In xmlNode.ChildNodes
                    Debug.WriteLine("childNode: " & childNode.Name & " value: " & childNode.InnerText)
                    Select Case childNode.Name.ToLower
                        Case "dc:title"
                            Me._Title = CStr(childNode.InnerText)
                        Case "dc:creator"
                            Me._Creator = CStr(childNode.InnerText)
                        Case "upnp:class"
                            Me._Class = CStr(childNode.InnerText)
                        Case "res"
                            ...
                            End If
                            Debug.WriteLine("Bevestig Resource: " & _Resource(_Resource.Length - 1).ToString)
                        Case "upnp:writestatus"
                            Select Case CStr(childNode.InnerText).ToUpper
                                Case "WRITABLE"
            ...
            Public Shared Function Create_CD_Object(ByVal xmlNode As XmlNode)
        ...
        Public Class CD_Item
            ...
            Public Sub New(ByVal xmlNode As XmlNode)
                ...
                For Each childNode As XmlNode In xmlNode.ChildNodes
                    ...
                    Select Case childNode.Name.ToLower
                        Case "upnp:artist"
                            Me._Artist = CStr(childNode.InnerText)
                        Case "upnp:album"
                            Me._Album = CStr(childNode.InnerText)
                        Case "upnp:genre"
                            Me._Genre = CStr(childNode.InnerText)
                    End Select
                Next
            End Sub
        ...
        Public Class CD_Container
            ...
            Dim _ChildCound As Integer = Nothing 'Required=no, MultipleValues=no
            ...
            Public Sub New(ByVal xmlNode As XmlNode)
                ...
                For Each tmpAttr As XmlAttribute In xmlNode.Attributes
                    Select Case tmpAttr.Name.ToLower
                        ...
                        Case "childcount"
                            Me._ChildCound = CInt(tmpAttr.Value)
                    End Select
                Next
            End Sub
